        ...
        <div className="hidden xl:block w-80 bg-zinc-100 shadow-2xl relative h-[calc(100vh-64px)] lg:h-[calc(100vh-96px)] overflow-auto">
            <div className='p-2 xl:p-3 w-full'>
                <ul id='admin_panel_sidebar' className="menu mt-7 h-fit">
                    ...
                    {(storedUser?.role === 'user') && <li className='mt-3'><NavLink to='wishlist' className={({ isActive }) => isActive ? "bg-primary hover:bg-primary text-gray-950 hover:text-gray-950" : "bg-gray-300 text-gray-950 hover:bg-primary hover:text-gray-950"}><MdRateReview />Add Review</NavLink></li>}
