        ...
        <>
            <div className="bg-[#fbfbfb] h-[100vh] overflow-auto relative flex mx-auto max-w-screen-4xl">
                ...
                <div className='w-full h-[100vh] overflow-auto'>
                    <div className='hidden xl:flex w-full justify-between py-10 border-b-2 px-5'>
                    ...
                    <div className='hidden sm:flex xl:hidden w-full px-3 sm:px-5 pt-3 sm:pt-5 pb-5 xs:pb-8 border-b justify-between'>
